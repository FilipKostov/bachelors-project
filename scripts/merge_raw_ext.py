...
raw_dir=Path("F:/steam_market_project/data/model_subset_csv")
ext_dir=Path("F:/steam_market_project/data/external")
out_dir=Path("F:/steam_market_project/data/model_subset_csv_raw_liquipedia")
...
raw_files=sorted(raw_dir.glob("subset_*.csv"))
